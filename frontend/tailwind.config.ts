...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'card': '0 1px 3px 0 hsl(260 81% 60% / 0.1), 0 1px 2px -1px hsl(260 81% 60% / 0.1)',
        'card-hover': '0 10px 25px -3px hsl(260 81% 60% / 0.15), 0 4px 6px -2px hsl(260 81% 60% / 0.1)',
        'bottom-nav': '0 -4px 20px -2px hsl(260 81% 60% / 0.1), 0 -1px 0 0 hsl(0 0% 90% / 0.5)',
      },
      animation: {
      ...
      backgroundImage: {
        ...
        'gradient-accent': 'linear-gradient(135deg, hsl(260 81% 60%) 0%, hsl(254 73% 78%) 50%, hsl(144 100% 80%) 100%)',
        'gradient-splash': 'linear-gradient(135deg, hsl(260 81% 60%) 0%, hsl(254 73% 78%) 50%, hsl(144 100% 80%) 100%)',
        'gradient-affirmation': 'linear-gradient(135deg, hsl(260 81% 60% / 0.12) 0%, hsl(254 73% 78% / 0.08) 100%)',
